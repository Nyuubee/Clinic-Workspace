...
/**
  * @privateRemarks
 * This has now been edited to use daisyui classes for ff components:
 * - input
 *  - text
 *  - date
 *  - textarea
 ...
 * - checkbox
  ...
  *
  * @checksum - 62867ef829f13f9be7925aeae80a9db8001e6d74a89a9bf79c32ed66fefb181f
  * @variables - radius=rounded,accentColor=blue,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:text__input": {
    "input": true,
    "input-bordered": true,
    "group-data-[disabled]:input-disabled": true,
  },
  ...
  "select__input": {
    ...
    "selection:text-base-200": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "group-data-[invalid]:select-error": true,
    "group-data-[disabled]:select-disabled": true,
    "min-w-0": true,
    "group-data-[prefix-icon]:!pl-0": true,
    "group-data-[suffix-icon]:!pr-0": true,
  ...
  "submit__input": {
    ...
    "group-data-[disabled]:!cursor-not-allowed": true,
    "dark:disabled:btn-disabled": true,
