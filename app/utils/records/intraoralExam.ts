...
export function useIntraoralExamSchema() {
    const schema = ref({
        $el: 'div',
        attrs: {
            class: 'flex flex-col gap-y-4 items-center md:items-start md:flex-row md:justify-around gap-x-12 xl:gap-x-4 flex-wrap',
        },
        children: [
            {
                $formkit: 'checkbox',
                        ...
                        children: [
                            {
                                ...
                                inputClass: 'select-ghost underline select-sm',
                                labelClass: 'self-center',
                                optionClass: 'flex flex-col justify-end',
                                validation: 'required',
                                options: [
